    ...
    <div class="table-responsive">
        <table class="table table-striped" style = "margin-top: 0px">
            ...
            <tr>
                ...
                <th><form action = "players.php?search=DriverLicense" method="post"><input class='btn-link' type='submit' name='orderBank' value="Leben"></form></th>
            ...
            while ($row = mysqli_fetch_array($search_result, MYSQLI_ASSOC)) {
                ...
                //echo '</td>';
                echo '<td>' ?>
                <input class="form-control" onBlur="dbSave(this.value, '<?php echo $row['id']; ?>', 'health', '<?php echo $row['health']; ?>')"; type=text value= "<?php echo $row['health']; ?>" >
                <?php
                echo '<td>' ?>
